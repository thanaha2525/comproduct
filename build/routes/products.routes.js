...
router.put('/:productId', _middlewares.authJwt.verifyToken, productsCtrl.updateProductById);
router["delete"]('/:productId', _middlewares.authJwt.verifyToken, productsCtrl.deleteProductById);
var _default = router;
